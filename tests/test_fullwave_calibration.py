...
def test_pending_table_is_rejected():
    with pytest.raises(FullWaveCalibrationError,match="no executed"):
        FullWaveCalibration("results/level3B/data/gap_calibration_table.csv")
