...
INPUTS = {
    "Level-3A.5 frozen network directory": ROOT / "results/level3A5",
    "Level-3A.5 hotspot data": ROOT / "results/level3A5/data/network_hotspots.csv",
    "Level-3A.5 PDA implementation": ROOT / "src",
